...
import ferreiras.dev.br.challenges.leetCode.ClassPreamble;
 ...
 * Your task is to complete the function min_sprinklers() which takes
 * the array gallery[ ] and the integer n as input parameters and
 * returns the minimum number of sprinklers that need to be turned on
 * to water the entire gallery.
 *
...
@ClassPreamble (
        ...
        reviewers = {},
        description = """
                Code to find out there is a
                sprinkler available to water
                all flowers.
                """
)
public class MinimumSprinklers {
  public static void main(String[] args) {
    int[] gallery = {2, 3, 4, -1, 0, 0, 0, 0, 0};
    int n = 9;
    int response = minSprinklers(gallery,n);
  }
